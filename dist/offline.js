!(function (e) {
    ...
    return (function () {
            ...
            return (
              "small" === a.type
                ...
                : ((l = e + s + Tr),
                  ...
                  ((r = Cr("sqrtTall", l, c, s, t)).style.minWidth = "0.742em"),
                  (n = 1.056)),
              (r.height = h),
              (r.style.height = ce(l)),
              {
      ...
      var jr = {},
        ...
        $r = function (e, t) {
          ...
          return (ee = yt.makeSpan(["tag"], [ee], t)), yt.makeFragment([l, ee]);
        },
      ...
      b({
        ...
        props: { numArgs: 1 },
        handler: function (e, t) {
          var r = (d(t[0]) ? [t[0]] : u(t[0], "ordgroup").body).map(function (
              e
            ) {
              var t = m(e).text;
      ...
      a({
        ...
        a({
          ...
          mathmlBuilder: function (e, t) {
            ...
            return (
              i.setAttribute("height", "0px"), i.setAttribute("depth", "0px"), i
            );
          },
        }),
        a({
            ...
            s = function (e, t) {
              ...
              for (
                ...
                if ("text" === n[a].type)
                  ...
                  try {
                    t.preProcess && (l = t.preProcess(l)), r().render(l, s, t);
                  } catch (e) {
  ...
  (function (e, t) {
    ...
    function x(e) {
      ...
      return (
        /OPR\/[\d.]+/.test(e.a)
          ...
          ? (i = "AdobeAIR")
          : -1 != e.a.indexOf("PlayStation") && (i = "BuiltinBrowser"),
        "BuiltinBrowser" == i
          ? (a = "Unknown")
          : "Silk" == i
          ? (a = w(e.a, /Silk\/([\d\._]+)/, 1))
          ...
          : "Opera" == i
          ? (a = w(e.a, /OPR\/([\d.]+)/, 1))
          : "PhantomJS" == i && (a = w(e.a, /PhantomJS\/([\d.]+)/, 1)),
        (a = f(a)),
        new g(
          i,
          0,
      ...
      if (((r = r || {}), 0 === t.length && a)) T(e.u);
        ...
        for (e.R += t.length, a && (e.aa = a), a = 0; a < t.length; a++) {
          ...
          h.B && l(h.p, [h.h.e(h.j, c.getName(), A(c).toString(), "loading")]),
            C(h, "fontloading", c),
            (h = null),
            (h = new E(i(e.ha, e), i(e.ia, e), e.d, o, e.k, e.W, n, s)).start();
        }
    }
    function F(e) {
      0 == --e.R &&
    ...
    function G(e, t, r) {
      (this.O = e || t + ee), (this.q = []), (this.V = []), (this.ea = r || "");
    }
    function j(e) {
      (this.q = e), (this.ca = []), (this.L = {});
    }
    function U(e, t) {
      (this.a = new v(navigator.userAgent).parse()), (this.d = e), (this.f = t);
    }
    function W(e, t) {
    ...
    unbind: function () {
      this.animationListeners.forEach(function (e) {
        var t = e[0],
          r = e[1],
          n = e[2];
        /click|touchstart/gi.test(r) && t.classList.remove("animation-trigger"),
