...
document.getElementById("openOBSbutton").addEventListener('click', () =>{
...
document.getElementById("IncreaseSpeedButton").addEventListener('click', () => {changeTeleprompterSpeed(5)})
document.getElementById("DecreaseSpeedButton").addEventListener('click', () => {changeTeleprompterSpeed(-5)})
